package array;
//Edited by Hannah Mungamuri on 2017Mar29 Wed
//package corejava.array;

/** * Find the Average Value of the numbers array * Eg : Avg value of 3,4,5,6,7 is equals (3+4+5+6+7)/5
 * @author jrout * */
public class AverageValue {
	public static void main(String[] args) {
		...
		for (int i=0; i<totalNum; i++){
			sum = sum + numbers[i];
			System.out.println("sum this far = "+sum);
		}
